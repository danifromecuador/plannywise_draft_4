    ...
    <div className="info">
      ...
      <div className={`${hide1} modal main-component`}>
        ...
        <ul>
          ...
          <li>If you&apos;re not hearing the alarm sound, please check out <a href="https://github.com/danifromecuador/plannywise_draft/issues/8" target='blank'>this issue</a></li>
